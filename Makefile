...
OBJS = Game.o Entity.o Tower.o Tile.o Tile_nothing.o Tile_tower.o Tile_enemy.o Tile_enemy_start.o Tile_enemy_end.o Resource_manager.o Health.o Enemy.o Enemy_basic.o Enemy_boss.o
